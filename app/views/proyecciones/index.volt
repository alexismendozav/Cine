        ...
        columns: [{
          ...
          },
          {
            ...
            "render": function (data, type, full, meta) {
              return '<div><button class="btn btn-warning"  onclick="editProyecciones(\'' + full
                .id_proyeccion + '\',\'' + full.pelicula + '\',\'' + full.sala + '\',\'' + full.dia +
                '\',\'' + full.horario +
                '\')" data-toggle="modal"   data-target="#modalEdit" > <i class="fa fa-pencil"></i> </button> </div> <button class="btn btn-danger" onclick="delProyeccion(\'' +
                full.id_proyeccion + '\')"><i class="fa fa-trash"></i> </button> </div>';
            }
          }
        ],
        "language": {
