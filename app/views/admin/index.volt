...
<div class="container">
  ...
  <script type="text/javascript">
    jQuery(document).ready(function ($) {
        ...
        columns: [{
          ...
          },
          {
            ...
            "render": function (data, type, full, meta) {
              return '<div><button class="btn btn-warning" onclick="editPelicula(\'' + full.id_pelicula +
                '\',\'' + full.nombre_pelicula + '\',\'' + full.imagen + '\',\'' + full.triler + '\',\'' +
                full.duracion + '\',\'' + full.calificacion + '\',\'' + full.categoria + '\',\'' + full
                .idioma + '\',\'' + full.prioridad + '\',\'' + full.calificacion + '\',\'' + full.fecha +
                '\',\'' + full.descripcion +
                '\')" data-toggle="modal"   data-target="#modalEdit" > <i class="fa fa-pencil"></i> </button> </div> <button class="btn btn-danger" onclick="deletePelicula(\'' +
                full.id_pelicula + '\',\'' + full.nombre_pelicula +
      ...
      $("#btnAdd").click(function () {
        ...
        addPelicula(nombre, imagen, triler, duracion, clasificacion, categoria, idioma, prioridad, calificacion,
          fecha, descripcion);
      ...
      $("#btnEdit").click(function () {
        ...
        editarPelicula(id, nombre, imagen, triler, duracion, clasificacion, categoria, idioma, prioridad,
          calificacion, fecha, descripcion);
        setTimeout(function () {
          tablePeliculas.ajax.reload(null, false);
        }, 500);
  ...
  <script type="text/javascript">
    function editPelicula(id, nombre, imagen, triler, duracion, clasificacion, categoria, idioma, prioridad,
      calificacion, fecha, descripcion) {
      $('#idEdit').val(id);
      $('#nameEdit').val(nombre);
    ...
    function addPelicula(nombre, imagen, triler, duracion, clasificacion, categoria, idioma, prioridad, calificacion,
      fecha, descripcion) {
      $.ajax({
        type: "POST",
    ...
    function editarPelicula(id, nombre, imagen, triler, duracion, clasificacion, categoria, idioma, prioridad,
      calificacion, fecha, descripcion) {
      $.ajax({
        type: "POST",
